                    ...
                    <div className="border-b border-white/20 flex justify-between items-center px-2 sm:py-6 py-4">
                        <div>
                            <div className="font-Bogart_Medium lg:text-3xl text-2xl flex items-center">
                                <FontAwesomeIcon icon={faBars} className="py-[6px] px-[7px] border-2 border-light-text dark:border-white  rounded-md mr-2 dark:text-white text-light-text" />
                                <p className="mr-2 text-Primary-Color font-semibold">
                                    {"<C/>"}
                                </p>
                                <p className="font-medium sm:block hidden">Subayyal <span className="lg:block hidden">Ayub</span></p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="flex xl:gap-5 md:gap-2 gap-1 font-Biotif-Regular items-center text-lg font-medium">
                                ...
                                <li>
                                    <label htmlFor="check" className="block bg-gray-300 dark:bg-gray-500 lg:w-16 md:w-10 w-16 h-8  md:h-5 lg:h-8  rounded-full relative ">
                                        <input type="checkbox" id="check" className="sr-only peer" onChange={handleThemeChange} checked={theme === "light"} value={theme} />
                                        <span className="bg-Primary-Color w-2/5 h-4/5 absolute rounded-full lg:left-[3px] md:left-[2px] left-[3px] lg:top-[3px] md:top-[2px] top-[3px] peer-checked:bg-gray-100 lg:peer-checked:left-9 md:peer-checked:left-[1.4rem] peer-checked:left-9 transition-all duration-500"></span>
                                    </label>
                                </li>
